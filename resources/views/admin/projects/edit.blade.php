        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"  name="description" id="description"  required>{{ old('description', $project->description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('organiztion') ? 'is-invalid' : '' }}" type="text" name="organiztion" id="organiztion" value="{{ old('organiztion', $project->organiztion) }}">
                    @if($errors->has('organiztion'))
                        <span class="text-danger">{{ $errors->first('organiztion') }}</span>
                    @endif
                    <span class="help-block">{{ trans('cruds.project.fields.organiztion_helper') }}</span>
                </div>
                <div class="form-group">
                    <label for="start">{{ trans('cruds.project.fields.start') }}</label>
                    <input class="form-control date {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $project->start) }}">
                    @if($errors->has('start'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('end') ? 'is-invalid' : '' }}" type="text" name="end" id="end" value="{{ old('end', $project->end) }}">
                    @if($errors->has('end'))
                ...
                <div class="form-group">
                    ...
                    <input id="input-tags" class="form-control" name="skills" id="skills" value="{{ old('skills',implode(',',$skills)) }}">
                </div>
                <div class="form-group">
                    <label for="role">{{ trans('cruds.project.fields.role') }}</label>
                    <input class="form-control {{ $errors->has('role') ? 'is-invalid' : '' }}" type="text" name="role" id="role" value="{{ old('role', $project->role) }}">
                    @if($errors->has('role'))
                        <span class="text-danger">{{ $errors->first('role') }}</span>
                    @endif
                    <span class="help-block">{{ trans('cruds.project.fields.role_helper') }}</span>
                </div>
                <div class="form-group">
                    <label for="link">{{ trans('cruds.project.fields.link') }}</label>
                    <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link" value="{{ old('link', $project->link) }}">
                    @if($errors->has('link'))
                        <span class="text-danger">{{ $errors->first('link') }}</span>
                    @endif
                    <span class="help-block">{{ trans('cruds.project.fields.link_helper') }}</span>
                </div>
                <div class="form-group">
